...
case "$target_env" in
   "dev")
      declare -A servers=(
         ...
         ["td_lae"]="d_eww_scratch_${mode}@devetl"
      )
   ;;
   "test")
      declare -A servers=(
         ...
         ["td_eww"]="t_eww_scratch_${mode}@testetl"
      )
   ;;
   "maui")
      declare -A servers=(
         ...
         ["staging"]="edwbuild@cheledwhdc901"
         ["td_ba"]="i_booking_${mode}@mauietl"
         ["td_eww"]="i_eww_scratch_${mode}@mauietl"
      )
   ;;
   "milan")
      declare -A servers=(
         ...
         ["staging"]="edwbuild@cheledwhdc901"
         ["td_ba"]="s_booking_${mode}@milanetl"
         ["td_eww"]="s_eww_scratch_${mode}@milanetl"
      )
   ;;
   "ppe")
      declare -A servers=(
   ...
   "prod")
      declare -A servers=(
         ...
         ["td_ba"]="p_booking_${mode}@prodetl"
         ["td_eww"]="p_eww_scratch_${mode}@prodetl"
      )
   ;;
   *)
